      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _kv(context, 'APP', 'guru_app'),
            _kv(context, 'TOKEN_SERVER', const String.fromEnvironment('TOKEN_SERVER', defaultValue: 'http://localhost:8787')),
            const SizedBox(height: 12),
            Text('Last 20 logs', style: Theme.of(context).textTheme.titleMedium),
            const SizedBox(height: 8),
            Flexible(
              child: Container(
